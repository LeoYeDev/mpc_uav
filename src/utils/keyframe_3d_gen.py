...
def random_periodical_trajectory(plot=False, random_state=303, map_limits=None):
...
if __name__ == "__main__":
    ...
    curve, attitude = random_periodical_trajectory(plot=True, random_state=300, map_limits=limits)
