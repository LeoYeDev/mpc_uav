...
def mse_tracking_experiment_plot(v_max, mse, traj_type_vec, train_samples_vec, legends, y_labels, t_opt=None,
    ...
    controller_plot_map = {
        'AR':       {'color': '#7C7CBA', 'marker': 's', 'linestyle': '-', 'linewidth': 2, 'markersize': 4, 'label': 'AR-MPC'},
        'SGP':       {'color': '#EECA40', 'marker': '^', 'linestyle': '-', 'linewidth': 2, 'markersize': 4, 'label': 'SGP-MPC'},
        'nominal':   {'color': '#23BAC5', 'marker': 'o', 'linestyle': '--', 'linewidth': 2, 'markersize': 4, 'label': 'Nominal MPC'},
        'perfect':   {'color': '#2ecc71', 'marker': 'x', 'linestyle': ':', 'linewidth': 2, 'markersize': 4, 'label': 'Perfect Model'},
    ...
    if t_opt is not None:
        ...
        sort_indices = np.argsort(v_flat)
        v_sorted = v_flat[sort_indices]
